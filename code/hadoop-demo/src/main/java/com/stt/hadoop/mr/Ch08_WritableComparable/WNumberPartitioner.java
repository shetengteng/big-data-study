 ...
 */
public class WNumberPartitioner extends Partitioner<WritableComparableFlowBean,Text> {
	@Override
	public int getPartition(WritableComparableFlowBean key, Text value, int numPartitions) {
